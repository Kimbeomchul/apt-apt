...
test('공식 전체 자료 범위·출처 검증',()=>assert.equal(validateDataset(data),true));
...
test('전용 59㎡와 84㎡ 혼동 방지',()=>{const a=structuredClone(data);a.apartments.find(a=>a.prices['59']).prices['59'].area=84;assert.throws(()=>validateDataset(a));});
